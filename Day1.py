...
calib_doc = calib_doc.replace("oneight", "1")
calib_doc = calib_doc.replace("twone", "2")
calib_doc = calib_doc.replace("threeight", "3")
calib_doc = calib_doc.replace("fiveight", "5")
calib_doc = calib_doc.replace("sevenine", "7")
calib_doc = calib_doc.replace("eighthree", "8")
calib_doc = calib_doc.replace("eightwo", "8")
calib_doc = calib_doc.replace("nineight", "9")
...
# Replace the linked numbers starting from the right
dup_calib_doc = dup_calib_doc.replace("eightwo", "2")
dup_calib_doc = dup_calib_doc.replace("eighthree", "3")
dup_calib_doc = dup_calib_doc.replace("twone", "1")
dup_calib_doc = dup_calib_doc.replace("oneight", "8")
dup_calib_doc = dup_calib_doc.replace("threeight", "8")
dup_calib_doc = dup_calib_doc.replace("fiveight", "8")
dup_calib_doc = dup_calib_doc.replace("nineight", "8")
dup_calib_doc = dup_calib_doc.replace("sevenine", "9")



# Replace regular numbers
dup_calib_doc = dup_calib_doc.replace("nine", "9")
dup_calib_doc = dup_calib_doc.replace("eight", "8")
dup_calib_doc = dup_calib_doc.replace("seven", "7")
dup_calib_doc = dup_calib_doc.replace("six", "6")
dup_calib_doc = dup_calib_doc.replace("five", "5")
dup_calib_doc = dup_calib_doc.replace("four", "4")
dup_calib_doc = dup_calib_doc.replace("three", "3")
dup_calib_doc = dup_calib_doc.replace("two", "2")
dup_calib_doc = dup_calib_doc.replace("one", "1")

calib_doc = str(calib_doc)
dup_calib_doc = str(dup_calib_doc)

#remove every letter from the string
new_calib_doc = "".join([char for char in calib_doc if not char.isalpha()])
new_dup_calib_doc= "".join([char for char in dup_calib_doc if not char.isalpha()])

#Split the string into line
calib_doc_lines = new_calib_doc.split("\n")
dup_calib_doc_lines = new_dup_calib_doc.split("\n")

final_num = 0

new_calib_doc_lines = ""
new_dup_calib_doc_lines = ""

for i, right_line_num in enumerate(calib_doc_lines):
    if right_line_num:
        new_right_line_num = right_line_num[0]
        new_calib_doc_lines += new_right_line_num
        print(new_right_line_num)

for i, left_line_num in enumerate(dup_calib_doc_lines):
    if left_line_num:
        new_left_line_num = left_line_num[-1]
        new_dup_calib_doc_lines += new_left_line_num
        print(new_left_line_num)

calib_doc_lines = new_calib_doc_lines
dup_calib_doc_lines = new_dup_calib_doc_lines

for calib_doc_line, dup_calib_doc_line in zip(calib_doc_lines, dup_calib_doc_lines):
        new_line = calib_doc_line + dup_calib_doc_line
        print(new_line)
        final_num += int(new_line)
